...
class QuizQuestons extends StatelessWidget {
  const QuizQuestons({super.key});
  static QuizController quizController = Get.put(QuizController());
  static ChoiceController choiceController = Get.put(ChoiceController());
  static TimerController timerController = Get.put(TimerController());
